    ...
    <ProtectedRoute>
      <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100 py-12 px-4">
        <div className="max-w-7xl mx-auto text-center mb-12">
          <h1 className="text-5xl font-bold mb-6">Dashboard de {usuarioAuth.fullName} </h1>
          <p className="text-2xl mb-8">
            Administra y visualiza los hechos desde este panel.
          </p>
        </div>

        <main className="max-w-7xl mx-auto px-6 py-5 space-y-12">
            ...
            <button
              ...
              className={`px-6 py-3 text-lg rounded-lg font-semibold transition-colors ${
                showCrearHecho
                  ...
                  : "bg-gray-300 text-gray-800 hover:bg-gray-500 hover:text-gray-200 dark:bg-gray-700 dark:text-gray-200"
              }`}
            >
