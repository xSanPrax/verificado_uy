  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-100 bg-opacity-90">
      <button
        ...
        className="absolute top-4 left-4 bg-red-500 hover:bg-red-400 text-white font-semibold py-2 px-4 rounded transition"
      >
        Cerrar
      </button>

      <div className="w-full max-w-3xl bg-white text-gray-800 p-8 rounded-lg shadow-lg">
